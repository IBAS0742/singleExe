...
reg add "HKLM\SOFTWARE\NetSarang\Xshell\6" /f /v Version /d "6.0.0109"
...
reg add "HKLM\SOFTWARE\NetSarang\Xmanager\6" /f /v Version /d "6.0.0103"
...
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xshell\6" /f /v Version /d "6.0.0109"
...
reg add "HKLM\SOFTWARE\Wow6432Node\NetSarang\Xmanager\6" /f /v Version /d "6.0.0103"
